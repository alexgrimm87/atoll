...
$(document).ready(function () {
    ...
    validate('.js-askForm', { submitFunction: validationCall });
    validate('.js-callForm', { submitFunction: validationCall });
    validate('.js-serviceForm', { submitFunction: validationCall });
